...
** Dial class
In Python, create a src_python{Dial(list)} type, with the list being
[value, count]. Overload addition and subtraction operators to apply
